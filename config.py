...
# dataset -----------------------
_C.DATA.BASEDIR = '~/data/coco/'
# All available dataset names are defined in `dataset/coco.py:register_coco`.
# All TRAIN dataset will be concatenated for training.
_C.DATA.TRAIN = ('coco_vis30yr_pngs_CS150',)   # Meng: need to add coco_ ahead
# Each VAL dataset will be evaluated separately (instead of concatenated)
_C.DATA.VAL = ('coco_vis30yr_pngs_CS150_val',)  # AKA minival2014
...
# backbone ----------------------
_C.BACKBONE.WEIGHTS = 'vis31yr_CS150_v0_vis_weight-930000.data-00000-of-00001' # 'COCO-MaskRCNN-R101FPN3xCasAug.npz'
# _C.BACKBONE.WEIGHTS = 'vis30yr_620000.data-00000-of-00001'
...
_C.BACKBONE.FREEZE_AT = 0  # train from scratch
...
_C.TRAIN.EVAL_PERIOD = 20 # 50  # period (epochs) to run evaluation
_C.TRAIN.CHECKPOINT_PERIOD = 20  # period (epochs) to save model

# preprocessing --------------------
# Alternative old (worse & faster) setting: 600
_C.PREPROC.TRAIN_SHORT_EDGE_SIZE = [640,800]  # [800, 800]  # [min, max] to sample from
...
_C.RPN.POSITIVE_ANCHOR_THRESH = 0.7 # default is 0.7
...
_C.RPN.MIN_SIZE = 0
_C.RPN.PROPOSAL_NMS_THRESH = 0.7 # default 0.7 # used 0.3 last time, missed a lot of images
...
# _C.FRCNN.BBOX_REG_WEIGHTS = [20., 20., 10., 10.] # Meng - try the better one
_C.FRCNN.FG_THRESH = 0.5 # default is 0.5
...
_C.CASCADE.IOUS = [0.5, 0.6, 0.7] # Meng - the first must be equal to _C.FRCNN.FG_THRESH
...
_C.TEST.RESULT_SCORE_THRESH = 1e-4  # default 0.05
